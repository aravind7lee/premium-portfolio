...
// previewGif: swap these with your own screen-recording GIFs or MP4s.
// If null, the card will just zoom the static image on hover (still looks great).
const projects = [
  {
    id: "resuflow",
    ...
    image: work8,
    previewGif: null, // e.g. "/previews/resuflow.gif"
    details:
